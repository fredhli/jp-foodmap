...
**Version: 2.2.0.** See [CHANGELOG.md](CHANGELOG.md) for what changed, and
...
not). It is version-locked to the site: **2.2.0**, `versionCode 20200`,
...
- **The Worker:** Cloudflare Workers → the worker → *Deployments* → the
  ...
  versa.
- Tagged releases (`v2.2.0`) mark the exact tree a deployment came from.
